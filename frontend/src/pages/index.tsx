...
export default function Home() {
  ...
  return (
    <main className="flex flex-col items-center justify-center min-h-screen p-4 bg-gradient-to-r from-cyan-300 via-purple-200 to-violet-300">
      <div className="space-y-4 w-full max-w-2xl">
        ...
        <form onSubmit={createUser} className="p-4 bg-blue-100 rounded shadow">
          ...
          <input
            ...
            className="mb-2 w-full p-2 border border-gray-300 rounde text-black"
          />
